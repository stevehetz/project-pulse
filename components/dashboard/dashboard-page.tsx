...
import { Box, SimpleGrid, Heading, Flex, Text, IconButton, Stat, StatLabel, StatNumber } from '@chakra-ui/react';
...
import { IMockData, IRevenue, ISystemPerformance, IUserEngagement, mockData } from '../../data/mockData'; // Importing the mock data
  ...
  return (
    <Flex direction="column" height="100vh">
      ...
      <Flex flex="1">
        ...
        <Box borderWidth="1px" borderRadius="lg" p={5} bgColor='#fff'>
          <Heading size="md" mb={4}>User Engagement</Heading>
          <Line data={userEngagementChartData} />
        </Box>
        <Box borderWidth="1px" borderRadius="lg" p={5} bgColor='#fff'>
          <Heading size="md" mb={4}>Revenue Metrics</Heading>
          <Line data={revenueChartData} />
        </Box>
        <Box borderWidth="1px" borderRadius="lg" p={5} bgColor='#fff'>
          <Heading size="md" mb={4}>Churn Rate</Heading>
          <Bar data={churnRateChartData} />
        </Box>
        <Box borderWidth="1px" borderRadius="lg" p={5} bgColor='#fff'>
          <Heading size="md" mb={4}>Server Uptime</Heading>
          <Line data={systemUptimeChartData} />
        </Box>
        <Box borderWidth="1px" borderRadius="lg" p={5} bgColor='#fff'>
          <Heading size="md" mb={4}>Response Times</Heading>
