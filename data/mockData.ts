...
export const mockData: IMockData = {
    ...
    revenue: [
      ...
      { month: 'Apr', MRR: 11500, ARPU: 23, churnRate: 4.2 },
      { month: 'May', MRR: 12000, ARPU: 24, churnRate: 4.1 },
      { month: 'Jun', MRR: 9500, ARPU: 25, churnRate: 4.0 },
      { month: 'Jul', MRR: 13000, ARPU: 26, churnRate: 3.8 },
      { month: 'Aug', MRR: 14500, ARPU: 27, churnRate: 3.7 },
      { month: 'Sep', MRR: 10000, ARPU: 28, churnRate: 3.6 },
      { month: 'Oct', MRR: 14500, ARPU: 29, churnRate: 3.5 },
      { month: 'Nov', MRR: 12000, ARPU: 30, churnRate: 3.4 },
      { month: 'Dec', MRR: 13500, ARPU: 31, churnRate: 3.3 },
      { month: 'Jan (next year)', MRR: 10000, ARPU: 32, churnRate: 3.2 },
      { month: 'Feb (next year)', MRR: 12500, ARPU: 33, churnRate: 3.1 },
      { month: 'Mar (next year)', MRR: 15000, ARPU: 34, churnRate: 3.0 },
    ],
    projectUsage: [
